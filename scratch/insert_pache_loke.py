# -*- coding: utf-8 -*-
"""
Database insertion script for কবিতা ৪ - পাছে লোকে কিছু বলে (Chapter ID: 219)
"""
import sys
import os
...
from scratch.data_pache_loke_mcq_p1 import MCQS_PACHE_P1
from scratch.data_pache_loke_mcq_p2 import MCQS_PACHE_P2
from scratch.data_pache_loke_sq_cq import SHORT_QUESTIONS, CREATIVE_QUESTIONS

CLASS_ID = 3       # ৮ম শ্রেণি
SUBJECT_ID = 47    # বাংলা ১ম পত্র
CHAPTER_ID = 219   # কবিতা ৪ - পাছে লোকে কিছু বলে (কামিনী রায়)

def insert_pache_loke_questions():
    with app.app_context():
        ...
        # 1. Insert MCQs
        all_mcqs = MCQS_PACHE_P1 + MCQS_PACHE_P2
        ...
        db.session.commit()
        print("Successfully committed all questions for কবিতা ৪ - পাছে লোকে কিছু বলে!")
