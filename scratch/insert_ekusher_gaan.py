# -*- coding: utf-8 -*-
"""
Database insertion script for কবিতা ১৩ - একুশের গান (Chapter ID: 650)
"""
import sys
import os
...
from scratch.data_ekusher_gaan_mcq_p1 import MCQS_EKUSHER_P1
from scratch.data_ekusher_gaan_mcq_p2 import MCQS_EKUSHER_P2
from scratch.data_ekusher_gaan_sq_cq import SHORT_QUESTIONS, CREATIVE_QUESTIONS

CLASS_ID = 3       # ৮ম শ্রেণি
SUBJECT_ID = 47    # বাংলা ১ম পত্র
CHAPTER_ID = 650   # কবিতা ১৩ - একুশের গান (আবদুল গাফফার চৌধুরী)

def insert_ekusher_gaan_questions():
    with app.app_context():
        ...
        # 1. Insert MCQs
        all_mcqs = MCQS_EKUSHER_P1 + MCQS_EKUSHER_P2
        ...
        db.session.commit()
        print("Successfully committed all questions for কবিতা ১৩ - একুশের গান!")
