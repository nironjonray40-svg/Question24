# -*- coding: utf-8 -*-
"""
Database insertion script for কবিতা ৫ - প্রার্থনা (Chapter ID: 643)
"""
import sys
import os
...
from scratch.data_prarthana_mcq_p1 import MCQS_PART1
from scratch.data_prarthana_mcq_p2 import MCQS_PART2
from scratch.data_prarthana_sq_cq import SHORT_QUESTIONS, CREATIVE_QUESTIONS

CLASS_ID = 3       # ৮ম শ্রেণি
SUBJECT_ID = 47    # বাংলা ১ম পত্র
CHAPTER_ID = 643   # কবিতা ৫ - প্রার্থনা (কয়কোবাদ)

def insert_prarthana_questions():
    with app.app_context():
        ...
        db.session.commit()
        print("Successfully committed all questions for কবিতা ৫ - প্রার্থনা!")
