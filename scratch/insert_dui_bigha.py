# -*- coding: utf-8 -*-
"""
Database insertion script for কবিতা ৩ - দুই বিঘা জমি (Chapter ID: 218)
"""
import sys
import os
...
from scratch.data_dui_bigha_mcq_p1 import MCQS_DUI_BIGHA_P1
from scratch.data_dui_bigha_mcq_p2 import MCQS_DUI_BIGHA_P2
from scratch.data_dui_bigha_sq_cq import SHORT_QUESTIONS, CREATIVE_QUESTIONS

CLASS_ID = 3       # ৮ম শ্রেণি
SUBJECT_ID = 47    # বাংলা ১ম পত্র
CHAPTER_ID = 218   # কবিতা ৩ - দুই বিঘা জমি (রবীন্দ্রনাথ ঠাকুর)

def insert_dui_bigha_questions():
    with app.app_context():
        ...
        print(f"Target Chapter: {chapter.chapter_no} - {chapter.title}")
        
        # 1. Insert MCQs
        all_mcqs = MCQS_DUI_BIGHA_P1 + MCQS_DUI_BIGHA_P2
        ...
        db.session.commit()
        print("Successfully committed all questions for কবিতা ৩ - দুই বিঘা জমি!")
